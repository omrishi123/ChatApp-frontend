...
export default function ChatList() {
  ...
  return (
    <div className="chat-list-container">
      <header>
        <img src={user.profilePic || '/default-avatar.png'} alt="Me" className="profile-pic" onClick={() => navigate('/profile')} />
        ...
        {chats.map(chat => {
          ...
          return (
            <li key={chat._id} className="chat-list-item" onClick={() => openChat(chat)}>
              <img src={other.profilePic || '/default-avatar.png'} alt={other.username} className="profile-pic" />
              <div>
